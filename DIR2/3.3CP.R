# CONFORMAL SET FOR HYPOCENTERS - STRONG OVERLAP
...
gamma_prob    <- read_csv("3gamma_probFS.csv")
...
# ==============================================================================
# PLOT EXPORTATION FOR SCENARIO 3
# ==============================================================================

# Compute plot objects for the Strong Overlap Scenario
plot_fs_ev0 <- plot_conformal_ipocentro(0)
plot_fs_ev1 <- plot_conformal_ipocentro(1)
plot_fs_ev2 <- plot_conformal_ipocentro(2)

# Set grid display boundaries (optimized for side-by-side printing layout)
plot_width  <- 10
plot_height <- 4.5

# Save files using the requested nomenclature structure (fig_3.3.1, 3.3.2, 3.3.3)
ggsave("fig_3.3.1.pdf", plot = plot_fs_ev0, width = plot_width, height = plot_height, dpi = 300)
ggsave("fig_3.3.2.pdf", plot = plot_fs_ev1, width = plot_width, height = plot_height, dpi = 300)
ggsave("fig_3.3.3.pdf", plot = plot_fs_ev2, width = plot_width, height = plot_height, dpi = 300)

cat("--- Scenario 3 Graphs (Strong Overlap) saved successfully: fig_3.3.1, 3.3.2, 3.3.3 ---\n")
