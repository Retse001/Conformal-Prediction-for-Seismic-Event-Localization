...
# ---  SAVING ---
write_csv(stazioni, "3stazioni_networkFS.csv")
write_csv(picks_finali, "3picks_simulatiFS.csv")
write_csv(eventi_verita, "3eventi_veritaFS.csv")
